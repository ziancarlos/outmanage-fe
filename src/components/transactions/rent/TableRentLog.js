          ...
          <CTable striped bordered responsive>
            <CTableHead>
              <CTableRow>
                ...
                <CTableHeaderCell scope="col">Transaksi Penyewaan</CTableHeaderCell>
            ...
            <CTableBody>
              {transactionRentLogs.map((log, idx) => (
                <CTableRow key={idx}>
                  <CTableDataCell>TRL{log.transactionRentLogId}</CTableDataCell>
                  <CTableDataCell>
                    <NavLink
                      to={`/transactions/rents/${log.transactionRentId}/detail`}
                    >{`TR${log.transactionRentId}`}</NavLink>
                  </CTableDataCell>
                  <CTableDataCell>
                    {canReadUser ? (
