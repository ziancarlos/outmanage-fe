            ...
            <CCol md={12} xs={12} className="mb-4">
              <CCard>
                ...
                <CCardFooter>
                  {transactionRent.paymentStatus !== 2 && (
                    <CButton
                      color="success" // Indicates positive financial action
                      variant="outline"
                      className="me-1"
                  ...
                  {transactionRentInventories.some(
                    ...
                    <CButton
                      color="warning" // Indicates attention is needed for billing
                      variant="outline"
                      className="me-1"
                      onClick={() => {
                        navigate(`/transactions/rents/${transactionRentId}/bill`)
                      }}
                    >
                  ...
                  {transactionRentInventories.some(
                    ...
                    <CButton
                      color="info" // Indicates an informational action for shipment
                      variant="outline"
                      className="me-1"
                  ...
                  {transactionRentInventories.some(
                    ...
                    <CButton
                      ...
                      className="me-1"
                      onClick={() => {
                        navigate(`/transactions/rents/${transactionRentId}/return`)
                      }}
                    >
                    ...
                    <CTable striped bordered responsive>
                      <CTableHead>
                        <CTableRow>
                          ...
                          <CTableHeaderCell scope="col">Harga Satuan per Bulan</CTableHeaderCell>
                      ...
                      <CTableBody>
                        {transactionRentInventories.map((item, idx) => (
                          <CTableRow key={idx}>
                            <CTableDataCell>TRI{item.transactionRentHasInventoryId}</CTableDataCell>
                            ...
                            <CTableDataCell>{item.rentedQuantity.toLocaleString()}</CTableDataCell>
                            <CTableDataCell>
                      ...
                      <CTableBody>
                        {transactionRentInventories.map((item, idx) => (
                          <CTableRow key={idx}>
                            ...
                            <CTableDataCell>{item.shippedQuantity.toLocaleString()}</CTableDataCell>
                            <CTableDataCell>
                    ...
                    <CTable striped bordered responsive>
                      <CTableHead>
                        <CTableRow>
                          ...
                          <CTableHeaderCell scope="col">Qty Diproses</CTableHeaderCell>
                          <CTableHeaderCell scope="col">Qty Belum Dikembalikan</CTableHeaderCell>
                        </CTableRow>
                      </CTableHead>
                      <CTableBody>
                        {transactionRentInventories.map((item, idx) => (
