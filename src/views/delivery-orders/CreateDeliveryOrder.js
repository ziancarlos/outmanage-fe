...
export default function CreateDeliveryOrder() {
  ...
  useEffect(() => {
    setError('')
  }, [customerValue, addressValue, internalNotesValue, itemValue, quantityValue, items])
  useEffect(() => {
  ...
  function isFormValid() {
    ...
    return isCustomerValid && hasItems && isAddressValid && isInternalNotesValid
  }
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      await axiosPrivate.post('/api/delivery-orders', request)
