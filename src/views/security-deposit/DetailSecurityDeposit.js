          ...
          <CCol md={12} xs={12} className="mb-4">
            <CCard>
              ...
              <CListGroup flush>
                ...
                <CListGroupItem>
                  Jumlah Deposit: {formatRupiah(securityDeposit.amount || 0)}
                </CListGroupItem>
                <CListGroupItem>
                  Jumlah Deposit Yang Dibayar: {formatRupiah(securityDeposit.totalPaid || 0)}
                </CListGroupItem>
                <CListGroupItem>
                  Jumlah Deposit Yang Dibalikkan: {formatRupiah(securityDeposit.totalReturn || 0)}
                </CListGroupItem>
              </CListGroup>

              <CCardFooter>
                {/* Show Pembayaran Deposit only if not fully paid (paymentStatus !== 2) */}
                {securityDeposit.paymentStatus !== 2 ? (
                  <CButton
                    color="primary"
                    variant="outline"
                ...
                {/* Show Pengembalian Deposit only if fully paid and not fully returned (paymentStatus === 2 && returnPaymentStatus !== 2) */}
                {securityDeposit.paymentStatus === 2 &&
                securityDeposit.returnPaymentStatus !== 2 ? (
                  <CButton
                    color="success"
            ...
            >
              <CForm onSubmit={handleReturnPaymentSubmit} noValidate>
                ...
                <CModalBody>
                  ...
                  {returnPaymentSuccess && <CAlert color="success">{returnPaymentSuccess}</CAlert>}
                  ...
                  <div className="mt-3 mb-3">
                    ...
                    <CFormRange
                      id="customRange2"
                      min={0}
                      max={parseInt(securityDeposit.amount) - parseInt(securityDeposit.totalReturn)}
                  ...
                  {checkedReturnPaymentMethodOptions === 'transfer' && (
                    <div>
                      ...
                      <div className="mb-3">
                        <CFormLabel className="fw-bold">Nama Rekening</CFormLabel>
                        <CFormInput type="text" readOnly value={returnAccountNameValue} disabled />
                      </div>
                    </div>
                  )}
                </CModalBody>
